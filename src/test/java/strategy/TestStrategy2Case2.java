...
public class TestStrategy2Case2 extends TestStrategyFramework {
	...
	@Test
	public void testStrategy2Case2() {
		Map<String, Object> response = null;
		Map<String, Object> params = null;
		String name1 = "testStrategy2Case2";
	...
	private void verifyResults(String user, List<Result> results) {
		Result ai2 = results.get(0);
		assertEquals(Ranking.ROYAL_FLUSH.toString(), ai2.getOutcome());
		assertEquals(Ranking.ROYAL_FLUSH.getValue(), ai2.getRank());
