...
public class TestStrategy1Case1 extends TestStrategyFramework {
	...
	public void testStrategy1Case1() {
		...
		String name1 = "testStrategy1Case1";
		...
		try {
			...
			assertEquals(0, poker.getOpponents().get(0).getVisibleCards().size());
	...
	private DevSetUp getSetup(String name) {
		...
		ai1.add(new Card(Rank.Five, Suit.Hearts));
		ai1.add(new Card(Rank.Six, Suit.Diamonds));
		ai1.add(new Card(Rank.Seven, Suit.Clubs));
		ai1.add(new Card(Rank.Eight, Suit.Spades));
		ai1.add(new Card(Rank.Nine, Suit.Diamonds));

		List<Card> ai2 = new ArrayList<Card>();
		ai2.add(new Card(Rank.Ace, Suit.Diamonds));
		ai2.add(new Card(Rank.Ace, Suit.Spades));
		ai2.add(new Card(Rank.Ace, Suit.Clubs));
		...
		ai3.add(new Card(Rank.Six, Suit.Clubs));
		ai3.add(new Card(Rank.Eight, Suit.Hearts));
		ai3.add(new Card(Rank.Jack, Suit.Spades));
		ai3.add(new Card(Rank.Jack, Suit.Hearts));
