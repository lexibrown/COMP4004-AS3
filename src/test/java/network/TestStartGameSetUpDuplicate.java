...
public class TestStartGameSetUpDuplicate extends TestNetworkFramework {
	...
	@Test
	public void testStartGameSetUpDuplicate() {
		Map<String, Object> response = null;
		Map<String, Object> params = null;
		String name1 = "testStartGameSetUpDuplicate1";
		String name2 = "testStartGameSetUpDuplicate2";
		...
		try {
			...
			params.put(Key.SETUP, JsonUtil.stringify(setUp));
			response = postRequest(JsonUtil.stringify(params));
			assertTrue(response.containsKey(Key.ERROR));
