...
public class TestStartGameFull extends TestNetworkFramework {
	...
	public void testStartGameFull() {
		...
		String name1 = "testStartGameFull1";
		String name2 = "testStartGameFull2";
		String name3 = "testStartGameFull3";
